<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-grey-800 leading-tight">Chat</h2>
    </x-slot>
    
    <div class="py-12">
        <div class="mac-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        window.addEventListener("DOMContentLoaded",()=>{
            ...
            window.Echo.private('chat').listen('MessageSent',(e) => {
                ...
                if(e.chat.chat_id === chatId){
                    ...
                    let elementUername = document.createElement("strong");
                    let elementMessage = document.createElement("div");
                    
                    elementUername = strUsername;
                    elementMessage.textContent = strMessage;
                    elementLi.append(elementUername);
